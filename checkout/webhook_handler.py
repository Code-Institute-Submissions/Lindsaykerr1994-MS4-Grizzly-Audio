...
class StripeWH_Handler:
    ...
    def _send_confirmation_email(self, order):
        # This function will send a confirmation email to the customer
    ...
    def handle_payment_intent_succeeded(self, event):
        ...
        # Update user info if they checked save_info
        # Profile is set to none to allow anon users to check out
        profile = None
